...
The difference tone, made of light.

**[Play →](https://jaspersimonds.github.io/emergent/moire/)**

Two fields of concentric rings, one still and one slowly drifting. Where their lines nearly coincide, a third pattern blooms — great sweeping curves that are drawn in neither field. It exists only in the *meeting*. Drag one field and the emergent figure swings enormously: a tiny shift in the source is a vast shift in the interference, because the third thing lives in the gap, not the parts.

**What it connects to:** the Tartini tone — sound two pure tones together and a third pitch appears, the difference frequency, present in neither source. This is that, in the eye instead of the ear. It's the sibling of *settling*: yesterday's swim found the difference tone you can hear, today's found the one you can see. Same truth, two senses — the third thing is generated by the collision, not contained in either component. And it's emergence in its barest form: two simple rules, a global form that's in neither, recognizable as beautiful because beauty is what deep structure surfacing looks like.

**Built with:** raw Canvas 2D — additive blending of two ring fields, a breathing spatial-frequency offset, and a Lissajous drift. No images, no audio. The whole thing is just two patterns and the light where they overlap.
